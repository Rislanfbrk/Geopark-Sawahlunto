...
<body>
    ...
    <section class="judul mt-5 mb-5">
        <div class="text-center">
            <h2 class="text-uppercase font-weight-bold mb-4" style="color: #6868ac;">Destinasi</h2>
        </div>
    </section>
                        ...
                        <div id="panelsStayOpen-collapseOne" class="accordion-collapse
                            ...
                            <div class="accordion-body">
                                ...
                                <div class="p-2">
                                    ...
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="selectcategory" id="flexRadioDefault1" value="pusat perbelanjaan">
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Pusat Perbelanjaan
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="selectcategory" id="flexRadioDefault1" value="monumen">
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Monumen
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="selectcategory" id="flexRadioDefault1" value="religi">
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Religi
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="selectcategory" id="flexRadioDefault1" value="nature">
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Nature and Outdoor
                                        </label>
                                    </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none" style="transform:rotate(180deg);margin-bottom:-1px">
        <path class="elementor-shape-fill" fill="#198754" opacity="0.33" d="M473,67.3c-203.9,88.3-263.1-34-320.3,0C66,119.1,0,59.7,0,59.7V0h1000v59.7
                 c0,0-62.1,26.1-94.9,29.3c-32.8,3.3-62.8-12.3-75.8-22.1C806,49.6,745.3,8.7,694.9,4.7S492.4,59,473,67.3z">
        </path>
        <path class="elementor-shape-fill" fill="#198754" opacity="0.66" d="M734,67.3c-45.5,0-77.2-23.2-129.1-39.1c-28.6-8.7-150.3-10.1-254,39.1
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 mb-5 mt-lg-5 mt-md-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <p>
                                    Pasar Sapan, Kel. Durian II, Saringan, Kec. Barangin, Kota Sawahlunto, Sumatera Barat 27422
                                </p>
                            </div>
                        </div>
                        <div class="row">
