                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="row">
                                <div class="col-6">
                                    <h6 class="font-weight-bold text-primary">Tambah Berita</h6>
                                </div>
                            ...
                            <div class="card-body">
                                <form action="{{ route('storeBerita') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="berita_name" id="title" class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="title">Lokasi Berita</label>
                                        <input type="text" name="berita_location" id="title" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="event_desc" class="form-label">Deskripsi</label>
                                        <textarea class="form-control" name="berita_desc" id="event_desc" rows="3"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="formFile" class="form-label">Cover</label>
                                        <input class="form-control" name="berita_cover" type="file" id="formFile" required>
                                    </div>
                                    <div class="mb-3">
