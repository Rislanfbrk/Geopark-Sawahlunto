...
<body>
    ...
    <img src="{{ asset('assets/img/header/surabaya.png') }}" style="width: 120px;" alt="Wisata Surabaya">
    </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 mt-4">
                    ...
                    <div>
                        <div class="mb-2">
                            <img class="image" src="assets/img/belanja/city-of-tomorrow-mall.jpeg" alt="CITO" height="400px" width="550px">
                        </div>
                    ...
                    <div>
                        <div class="mb-2">
                            <img class="image" src="assets/img/monumen/tugupahlawan.jpg" alt="Tugu Pahlawan" height="363px" width="550px">
                        </div>
