...
<body>
    ...
    <section class="judul mt-5 mb-5">
        <div class="text-center">
            <h2 class="text-uppercase font-weight-bold mb-4" style="color: #6868ac;">Berita</h2>
        </div>
    </section>
    ...
    <section class="mb-5 mt-3">
        <div id="app">
            ...
            <div class="container">
                <form action="{{ route('filterBerita') }}" method="GET">
                    <div class="row" id="accordionPanelsStayOpenExample">
                            ...
                            <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span class="font-weight-bold" style="font-size: 20px;
                                            color: #e1ad01;">Filter Kategori</span>
                                </button>
                            </h2>
                        </div> --}}
                        ...
                        <div id="panelsStayOpen-collapseTwo" class="accordion-collapse
                            ...
                            <div class="accordion-body">
                                <div class="mt-2 mb-2">
                                    <input class="form-control" type="text" name="search" placeholder="Cari Berdasarkan Tanggal">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container text-center">
                    <div class="row">
                        @foreach ($berita as $ev)
                        <div class="col-lg-4 col-md-12">
                            <a href="{{ route('detailBerita', [$ev->id]) }}" style="text-decoration: none; ">
                                <div class="mb-2 mt-3 img-rounded-hover-effect">
                                    <img src="{{ asset('cover/' . $ev->berita_cover) }}" alt="Berita" class="img-fluid">
                                </div>
                                <hr class="mt-2 mb-2 badge-primary" style="border: 1.5px solid
                                        #6868ac; border-radius: 5px" />
                                <div>
                                    <h5 class='font-weight-bold' style="color: black"> {{ $ev->berita_name }} </h5>
